...
//User must get an appropriate error message regarding Phone number: Must be valid phone number and cannot be empty.
...
public class Amazon_Testcase_26 {
	
	public Amazon_Testcase_26() throws InterruptedException {
		    ...
		    String actual = driver.findElement(By.xpath("//div[contains(text(),'Please enter a phone number so we can call if ther')]")).getText();
		    String expected = "Please enter a phone number so we can call if there are any issues with delivery.";
