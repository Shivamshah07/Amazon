...
//The cart should update showing the existing items in the cart, total price should reflect the new sum if any item/items are removed
...
public class Amazon_Testcase_50 {

	public Amazon_Testcase_50() throws InterruptedException {
			...
			String actu = driver.findElement(By.className("a-truncate sc-grid-item-product-title a-size-base-plus")).getText();
			String expe = "Under Armour Men's Tech 2.0 Short-Sleeve T-Shirt";
