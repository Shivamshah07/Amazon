...
//Clicking on add Address Module must navigate us to add address option.
...
public class Amazon_Testcase_23 {
	
	public Amazon_Testcase_23() throws InterruptedException {
		...
		//	WebElement Signup = driver.findElement(By.xpath("//*[@id=\"nav-flyout-ya-newCust\"]/a"));
		    ...
		    String actual = driver.findElement(By.id("address-ui-widgets-reload-url")).getText();
