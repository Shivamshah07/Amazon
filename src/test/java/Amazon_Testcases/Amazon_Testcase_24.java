...
//Country/region: Canada must be auto selected
...
public class Amazon_Testcase_24 {
	
	public Amazon_Testcase_24() throws InterruptedException {
		   ...
		   String actual = driver.findElement(By.xpath("//*[@id=\"address-ui-widgets-enterAddressFormContainer\"]/div[1]/div/div[2]")).getText();
