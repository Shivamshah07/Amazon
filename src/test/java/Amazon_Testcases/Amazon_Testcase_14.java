...
public class Amazon_Testcase_14 {
	
	public Amazon_Testcase_14() throws InterruptedException, NoSuchElementException {
	    ...
	    WebElement keep = driver.findElement(By.xpath("//body/div[@id='a-page']/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/form[1]/div[1]/div[2]/div[1]/div[1]/label[1]/div[1]/label[1]/input[1]"));
	    keep.click();
	    boolean signin =keep.isSelected();
