...
//After Login, User can view and access his account information by clicking on "Account & List" 
//choose options from sub list  
...
public class Amazon_Testcase_16 {
	
	public Amazon_Testcase_16() throws InterruptedException, NoSuchElementException {
	    ...
	    WebElement element3 = driver.findElement(By.xpath("//span[contains(text(),'Your Account')]"));
	    act.moveToElement(element3).click();
	    
	    driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);
	    String expected = "Your Account";
	    String actual = driver.findElement(By.xpath("//h1[contains(text(),'Your Account')]")).getText();
