...
//Password again must accept exact value as Password field, 
//if not entered same it must through appropriate error message.
...
public class Amazon_Testcase_09 {
	
	public Amazon_Testcase_09() throws InterruptedException, NoSuchElementException {
